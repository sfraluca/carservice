      ...
      <div class="container" > 
        <div class="row">
          <div class="col-lg-8 mx-auto transbox">
            <h2 class="">We are...</h2>
            <p class="">An service auto application ready to interract with you. We are here to support you and your car. And now everything is more easier with this new technology.</p>
          </div>
        </div>
